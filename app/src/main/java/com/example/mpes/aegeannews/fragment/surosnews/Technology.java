package com.example.mpes.aegeannews.fragment.surosnews;
...
public class Technology extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (v == null) {
            v = inflater.inflate(R.layout.news_technology, container, false);
            progressBar = (ProgressBar) v.findViewById(R.id.progressBar);

            new HTTPDownloadTask().execute("http://rss.nytimes.com/services/xml/rss/nyt/Education.xml");
