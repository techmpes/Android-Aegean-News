package com.example.mpes.aegeannews.fragment.rodosnews;
...
public class Sports extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (v == null) {
            v = inflater.inflate(R.layout.news_sports, container, false);
            progressBar = (ProgressBar) v.findViewById(R.id.progressBar);

            new HTTPDownloadTask().execute("http://www2.enikos.gr/feeds/menu/sports.xml");
