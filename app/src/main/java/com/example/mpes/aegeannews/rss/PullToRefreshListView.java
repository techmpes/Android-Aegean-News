...
public class PullToRefreshListView extends ListView{
    ...
    private void init(){
        ...
        headerContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.rss_header, null);
        ...
        lastUpdatedText = getContext().getString(R.string.last_updated);
